...
if __name__ == "__main__":  
    ...
    # Save scores
    np.save(f"{PATH_RES}/raw/ft_{str_bn}_{str_std}_{loss_prefix}{dname_i}_{dname_o}_{sname}_{args.loss}_id.npy", np.array(scores_i))
    np.save(f"{PATH_RES}/raw/ft_{str_bn}_{str_std}_{loss_prefix}{dname_i}_{dname_o}_{sname}_{args.loss}_ood.npy", np.array(scores_o))